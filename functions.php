		...
		while ($row = fetch_array($query2)) {
			...
			$product = <<<DELIMETER
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h4 class="pull-right">{$row['product_price']} FCFA</h4>
                                <h4><a href="item.php?id={$row['product_id']}">{$row['product_title']}</a>
                                </h4>
								<a class="btn btn-primary" target="_blank" href="../resources/cart.php?add={$row['product_id']}">Ajouter au panier</a>
                            </div>
				...
				<div class="col-md-3 col-sm-6 hero-feature">
	                <div class="thumbnail">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>{$row['short_desc']}</p>
	                        <p>
	                            <a href="../resources/cart.php?add={$row['product_id']}" class="btn btn-primary">Acheter</a>
								 <a href="item.php?id={$row['product_id']}" class="btn btn-default">Voir plus</a>
	                        </p>
	                    </div>
	                </div>
            	</div>
				...
				<div class="col-md-2 col-sm-4 hero-feature small_height">
	                <div class="thumbnail">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>{$row['short_desc']}</p>
	                        <p>
	                            <a href="../resources/cart.php?add={$row['product_id']}" class="btn btn-primary col-md-5">Acheter</a> 
								<a href="item.php?id={$row['product_id']}" class="btn btn-default col-md-5">Voir plus</a>
	                        </p>
	                    </div>
	                </div>
            	</div>
